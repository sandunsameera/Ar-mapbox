...
class HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF12086d),
        leading: IconButton(
            icon: Icon(FontAwesomeIcons.arrowLeft),
            onPressed: () {
              //
            }),
        title: Text("Wayamba university"),
        actions: <Widget>[
          IconButton(
 ...
 Future<void> _minus(double zoomVal) async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: LatLng(7.322386, 79.987007), zoom: zoomVal)));
  }
